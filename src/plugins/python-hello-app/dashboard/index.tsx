...
function PythonHelloPage() {
  ...
  const appUrl = useMemo(() => {
    if (import.meta.env.VITE_PYTHON_HELLO_URL) {
      return import.meta.env.VITE_PYTHON_HELLO_URL;
    }
    return `${window.location.protocol}//${window.location.hostname}:5000/hello`;
  }, []);
